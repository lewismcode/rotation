...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="grid h-9 w-9 place-items-center rounded-full border border-[var(--glass-border)] text-secondary transition-colors hover:border-accent hover:text-primary"
    >
